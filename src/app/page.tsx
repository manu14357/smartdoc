  ...
  const features = [
    {
      ...
      description:
        "Our advanced AI understands context and nuances in your documents, providing precise and relevant insights.",
    },
    {
      icon: <Clock className="h-6 w-6 text-[hsl(272.1,71.7%,47.1%)]" />,
      title: "Save Hours of Work",
      description:
        "Stop spending hours reading through documents. Get instant answers to your questions and quick summaries.",
    },
    {
      icon: <Shield className="h-6 w-6 text-[hsl(272.1,71.7%,47.1%)]" />,
      title: "Secure & Private",
      description:
        "Your documents are encrypted and processed in a secure environment. We prioritize your privacy and data security.",
    },
  ];
  ...
  const useCases = [
    {
      ...
      description:
        "Quickly analyze research papers, extract key findings, and generate literature reviews.",
    },
    {
      icon: <Building2 className="h-8 w-8 text-[hsl(272.1,71.7%,47.1%)]" />,
      title: "Business Professionals",
      description:
        "Process contracts, reports, and business documents efficiently with AI assistance.",
    },
    {
      icon: <Code className="h-8 w-8 text-[hsl(272.1,71.7%,47.1%)]" />,
      title: "Technical Teams",
      description:
        "Understand technical documentation, analyze specifications, and extract requirements.",
    },
  ];
    ...
    <>
      <MaxWidthWrapper className="mb-12 mt-28 sm:mt-40 flex flex-col items-center justify-center text-center">
        ...
        >
          <div className="inline-flex items-center justify-center space-x-3 bg-white border border-gray-200 rounded-full px-4 py-2 shadow-md">
            ...
            <span className="text-sm font-medium text-gray-800">
              Introducing{" "}
              <span className="font-bold text-blue-600">SmartDoc AI 🚀</span>
            </span>
        ...
        <p className="mt-5 max-w-prose text-zinc-700 sm:text-lg">
          Experience the future of document interaction. Upload any PDF and
          start having meaningful conversations instantly. Perfect for research,
            ...
            {[
              {
                ...
                description:
                  "Simply drag and drop your PDF. We support research papers, reports, contracts, and more.",
              },
              {
                step: "2",
                title: "AI Processing",
                description:
                  "Our advanced AI analyzes your document, understanding its content, context, and key information.",
              },
              {
                step: "3",
                title: "Start Conversations",
                description:
                  "Ask questions naturally and get instant, accurate responses about your document's content.",
              },
            ].map((item, index) => (
      ...
      <div className="mx-auto max-w-7xl px-6 py-20">
        <div className="bg-gradient-to-br from-blue-600 to-purple-700 rounded-2xl p-8 md:p-12 text-white text-center">
          <h2 className="text-3xl font-bold mb-4">
            Be Among the First to Try SmartDoc
          </h2>
          <p className="mb-8 max-w-2xl mx-auto">
            Join our beta program and get exclusive early access to SmartDoc.
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              ...
              className={buttonVariants({
                ...
                variant: "outline",
                className:
                  "bg-white text-[hsl(272.1,71.7%,47.1%)] hover:bg-gray-100",
              })}
            >
              Start Free Trial
              <ArrowRight className="ml-2 h-5 w-5" />
