    ...
    <nav className="sticky h-14 inset-x-0 top-0 z-30 w-full border-b border-gray-200 bg-white/75 backdrop-blur-lg transition-all">
      <MaxWidthWrapper>
        <div className="flex h-14 items-center justify-between border-b border-zinc-200">
          ...
          <Link href="/" className="flex items-center font-bold text-3xl">
...
const NavigationAuthButtons = () => (
  <>
    ...
    <LoginLink className="font-semibold text-gray-700 hover:text-[hsl(272.1,71.7%,47.1%)] transition-colors duration-300 ease-in-out transform hover:scale-105">
      Sign in
    </LoginLink>
    <RegisterLink className="font-bold text-white bg-[hsl(272.1,71.7%,47.1%)] px-4 py-2 rounded-full hover:bg-[hsl(272.1,71.7%,47.1%)] hover:bg-opacity-80 transition-all duration-300 ease-in-out flex items-center group shadow-md hover:shadow-lg">
      Get started{" "}
...
const NavigationUserButtons = ({
  ...
  <>
    ...
    <UserAccountNav name={name} email={email} imageUrl={imageUrl} />
  </>
);
